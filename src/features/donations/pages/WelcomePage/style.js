...
const ConteudoContainer = styled.div`
    ...
    border-radius: 10px;
    position: relative;
    background-image: linear-gradient(to bottom, rgb(243, 153, 18) 50%, rgb(252, 122, 17));
...
export { BackGroundContainer, ConteudoContainer, NavegarContainer, BotaoTextoContainer };